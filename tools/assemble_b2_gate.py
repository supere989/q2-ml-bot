...
RETIRED_71448_QUALIFICATION_SUCCESSOR_PATHS = frozenset({
    "docs/multires/B2-C-GENERATOR-CLAIM-CONTRACT.md",
    "docs/multires/B2-GATE-ASSEMBLY.md",
...
RETIRED_71449_QUALIFICATION_SUCCESSOR_PATHS = frozenset({
    "docs/multires/B2-C-GENERATOR-CLAIM-CONTRACT.md",
    "docs/multires/B2-GATE-ASSEMBLY.md",
...
# Cohort 71449 consumed its one-shot source authorization and failed at the
# sole Dyn invocation on operator argv parsing. A separately committed
# post-qualification successor is required before this may become non-None
# again; the current alias is never sufficient to infer executable authority.
