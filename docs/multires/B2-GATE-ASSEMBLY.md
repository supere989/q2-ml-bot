...
The 71432 source freeze, generated Atlas build report, test report, every
...
- `tools/run_generator_cohort.py generate` writes the exact 71432 source
...
- `tools/q2-dyn-evidence` runs on `DESKTOP-RTX2080` WSL and atomically writes
  ...
  member of the admitted 71432 population. The assembler binds it to the exact
