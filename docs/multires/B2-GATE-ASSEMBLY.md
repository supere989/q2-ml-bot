...
The 71430 source freeze, generated Atlas build report, test report, every
...
- `tools/run_generator_cohort.py generate` writes the exact 71430 source
...
- `tools/q2-dyn-evidence` runs on `DESKTOP-RTX2080` WSL and atomically writes
  ...
  member of the admitted 71430 population. The assembler binds it to the exact
