...
The 71434 source freeze, generated Atlas build report, test report, every
...
- `tools/run_generator_cohort.py generate` writes the exact 71434 source
...
- `tools/q2-dyn-evidence` runs on `DESKTOP-RTX2080` WSL and atomically writes
  ...
  member of the admitted 71434 population. The assembler binds it to the exact
